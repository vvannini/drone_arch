...
# export PX4_HOME_LAT=-12.82046769976293; export PX4_HOME_LON=-50.33633513165995; export PX4_HOME_ALT=847.142652; export NAV_RCL_ACT=0; export MAV_BROADCAST=1; make px4_sitl gazebo
# roslaunch mavros px4.launch fcu_url:="udp://:14540@127.0.0.1:14557"
# ./tutorial.bash 
#!/bin/sh
gnome-terminal -- /bin/bash -c 'cd drone_ws/; source devel/setup.bash; roslaunch ROSPlan_action_init.launch; sleep 30'
sleep '20'
gnome-terminal -- /bin/bash -c 'cd ../Firmware/;export PX4_HOME_LAT=-12.82046769976293; export PX4_HOME_LON=-50.33633513165995; export PX4_HOME_ALT=847.142652; export NAV_RCL_ACT=0; export MAV_BROADCAST=1; make px4_sitl gazebo; sleep 30'
sleep '20'
gnome-terminal -- /bin/bash -c 'roslaunch mavros px4.launch fcu_url:="udp://:14540@127.0.0.1:14557"; sleep 30'
