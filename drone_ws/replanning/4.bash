...
echo "Update KB"
python3 src/data/scripts/create_pddl_global.py 19096
...
echo "Creating log"
python3 src/data/scripts/create_log.py 19096 0
...
python3 replanning/update.py 1 20604
...
echo "Creating log"
python3 src/data/scripts/create_log.py 20604 1
...
echo "Cancel atual plan & Update Goal"
python3 replanning/update.py 1 20648
...
echo "Creating log"
python3 src/data/scripts/create_log.py 20648 1
