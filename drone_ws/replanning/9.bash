...
echo "Update KB"
python3 src/data/scripts/create_pddl_global.py 39916
...
echo "Creating log"
python3 src/data/scripts/create_log.py 39916 0
...
python3 replanning/update.py 1 281
...
echo "Creating log"
python3 src/data/scripts/create_log.py 281 1
...
echo "Cancel atual plan & Update Goal"
python3 replanning/update.py 1 20637
...
echo "Creating log"
python3 src/data/scripts/create_log.py 20637 1
