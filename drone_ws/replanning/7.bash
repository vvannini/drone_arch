...
echo "Update KB"
python3 src/data/scripts/create_pddl_global.py 39655
...
echo "Creating log"
python3 src/data/scripts/create_log.py 39655 0
...
python3 replanning/update.py 1 91
...
echo "Creating log"
python3 src/data/scripts/create_log.py 91 1
...
echo "Cancel atual plan & Update Goal"
python3 replanning/update.py 1 82
...
echo "Creating log"
python3 src/data/scripts/create_log.py 82 1
