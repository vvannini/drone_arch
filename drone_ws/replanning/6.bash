...
echo "Update KB"
python3 src/data/scripts/create_pddl_global.py 19917
...
echo "Creating log"
python3 src/data/scripts/create_log.py 19917 0
...
python3 replanning/update.py 1 20810
...
echo "Creating log"
python3 src/data/scripts/create_log.py 20810 1
...
echo "Cancel atual plan & Update Goal"
python3 replanning/update.py 1 164
...
echo "Creating log"
python3 src/data/scripts/create_log.py 164 1
