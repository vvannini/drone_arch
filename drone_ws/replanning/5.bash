...
echo "Update KB"
python3 src/data/scripts/create_pddl_global.py 18988
...
echo "Creating log"
python3 src/data/scripts/create_log.py 18988 0
...
python3 replanning/update.py 1 20661
...
echo "Creating log"
python3 src/data/scripts/create_log.py 20661 1
...
echo "Cancel atual plan & Update Goal"
python3 replanning/update.py 1 332
...
echo "Creating log"
python3 src/data/scripts/create_log.py 332 1
