 ...
 * @author Hossomi
 */
public class GCILTBInstance extends Instance {
	...
	public double[][]	Pik,		// Number of products i produced per day in machine k
						...
						Cly;		// Estimated capacity of oven y to produce color l
	...
	public void parameters(LinkerParameters com) throws Exception {
		file = com.File("Instances for GCILTB",null,"dat");
	}
	...
	public int randomColor(GCILTBProblem problem, int y) {
		int l;
		do {
			l = problem.rnd.nextInt(0, L - 1);
		} while (!Ly[y].contains(l));
