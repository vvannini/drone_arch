 ...
 * @author marcio
 */
public class ExactBestSol extends ExactBest{
    private static ExactBestSol obj = null;
    public static ExactBestSol object(){
        if(obj==null){
            obj = new ExactBestSol();
        }
        return obj;
    }

    private class Sol{
        private ExactNode base;
        private long eval;
        private long ints;
        ...
        public Sol(ExactNode sol, long eval, long ints, double time, double progress) {
            this.base = sol;
            this.eval = eval;
            this.ints = ints;
            this.time = time;
    ...
    @Override
    public ExactNode ind() throws Exception {
        return best.base;
    }
    public long id(){
        return best.eval;
    ...
    @Override
    public void results(aComb prob, LinkerResults link) throws Exception {
    ...
    @Override
    public void better(aComb prob, ExactNode base) throws Exception {
    ...
    @Override
    public void flush(aComb prob) throws Exception {
        if(print_buffer){
            best.progress = stop.progress();
            com.printLong("eval", best.eval);
            com.printDbl("time", time_best());
