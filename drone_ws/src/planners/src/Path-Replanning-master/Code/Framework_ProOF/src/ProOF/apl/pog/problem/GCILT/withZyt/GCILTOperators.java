...
public class GCILTOperators extends Factory<Operator> {
    ...
    private static class opInitializer extends oInitialization <GCILTWProblem, GCILTCodification> {
        @Override
        public String name() {
            return "Initializer";
        }
        @Override
        public void initialize(GCILTWProblem problem, GCILTCodification ind) throws Exception {
    ...
    private static class opCrossoverMacroOX extends oCrossover <GCILTWProblem, GCILTCodification> {
        @Override
        public GCILTCodification crossover(GCILTWProblem problem, GCILTCodification ind1, GCILTCodification ind2) throws Exception {
    ...
    private static class opCrossoverMacro1PT extends oCrossover <GCILTWProblem, GCILTCodification> {
    ...
    private static class opCrossoverMacro1PY extends oCrossover <GCILTWProblem, GCILTCodification> {
    ...
    private static class opCrossoverMicroOX extends oCrossover <GCILTWProblem, GCILTCodification> {
    ...
    private static class opCrossoverMicro1P extends oCrossover <GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationColorChange extends oMutation<GCILTWProblem, GCILTCodification> {

        @Override
        public void mutation(GCILTWProblem mem, GCILTCodification ind) throws Exception {
    ...
    private class opLocalMoveColorChange extends oLocalMove<GCILTWProblem, GCILTCodification> {

        @Override
        public void local_search(GCILTWProblem mem, GCILTCodification ind) throws Exception {
            mutationColorChange( mem, ind );
        }
    ...
    private class opMutationLotSwap extends oMutation<GCILTWProblem, GCILTCodification> {
    ...
    private class opLocalMoveLotSwap extends oLocalMove<GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationTimeSwap extends oMutation<GCILTWProblem, GCILTCodification> {
    ...
    private class opLocalMoveTimeSwap extends oLocalMove<GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationRemoveLot extends oMutation<GCILTWProblem, GCILTCodification> {
    ...
    private class opLocalMoveRemoveLot extends oLocalMove<GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationAddLot extends oMutation<GCILTWProblem, GCILTCodification> {
    ...
    private class opLocalMoveAddLot extends oLocalMove<GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationTimeTransfer extends oMutation<GCILTWProblem, GCILTCodification> {
    ...
    private class opLocalMoveTimeTransfer extends oLocalMove<GCILTWProblem, GCILTCodification> {
    ...
    private class opMutationDaysChange extends oMutation<GCILTWProblem, GCILTCodification> {
        @Override
        public void mutation(GCILTWProblem mem, GCILTCodification ind) throws Exception {
    ...
    private class opLocalMoveDaysChange extends oLocalMove<GCILTWProblem, GCILTCodification> {
        @Override
        public void local_search(GCILTWProblem mem, GCILTCodification ind) throws Exception {
            mutationDaysChange( mem, ind );
        }
    ...
    private static void mutationDaysChange( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
    ...
    private static void mutationColorChange( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	GCILTLot lot;
        int y, t, i, l;
    ...
    public static int randomColor( GCILTWProblem problem, int y ) {
	int l;
	do {
    ...
    private static void mutationLotSwap( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	GCILTLot lota, lotb;
    ...
    private static void mutationTimeSwap( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	GCILTLot lota, lotb;
	LinkedList<GCILTLot> list;
        int y, t, i, j;
    ...
    private static void mutationTimeTransfer( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	GCILTLot lota, lotb;
	LinkedList<GCILTLot> list;
        int y, t, i, j, time;
    ...
    private static void mutationRemoveLot( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	LinkedList<GCILTLot> list;
        int y, t, i;
    ...
    private static void mutationAddLot( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
	LinkedList<GCILTLot> list;
    ...
    private static void repairAllOvens( GCILTWProblem problem, GCILTCodification ind ) throws Exception {
        for (int y = 0; y < problem.inst.Y; y++)
	    repairOvenLots( problem, ind, y, 0, 0);
    }
    
    private static void repairOvenLots( GCILTWProblem problem, GCILTCodification ind, int y, int t0, int i0 ) throws Exception {
	GCILTInstance inst = problem.inst;
    ...
    private static void normalize( GCILTWProblem problem, GCILTCodification ind, int y, int t ) throws Exception {
	GCILTLot curLot;
	LinkedList<GCILTLot> list;
	...
	GCILTWProblem problem = new GCILTWProblem();
