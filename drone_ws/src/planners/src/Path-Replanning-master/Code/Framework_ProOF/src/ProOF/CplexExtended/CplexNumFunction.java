 ...
 * @author marcio
 */
public abstract class CplexNumFunction implements iCplexFunction1v{
    private final IloNumVar v[];
    public final IloNumVar x;
    public final IloNumVar f;
    public final int N;
    public final String name;
    public CplexNumFunction(CplexExtended cplex, int N, boolean bounded, String name) throws IloException {
        this.N = N;
        this.name = name;
