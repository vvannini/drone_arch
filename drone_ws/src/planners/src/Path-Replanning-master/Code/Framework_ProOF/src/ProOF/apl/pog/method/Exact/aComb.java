 ...
 * @param <B>
 */
public abstract class aComb<B extends ExactBest> extends ProOF.com.language.Approach {
    public final uRandom rmd = new uRandom();
    public abstract B best();
    
    public abstract ExactNode frist_node() throws Exception;
    ...
    public void update(ExactNode no) throws Exception{
        if(best()!=null){
            best().better(this, no);
        }
    }
