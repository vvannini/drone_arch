 ...
 * @author marcio
 */
public final class CCQSPModelRelaxed2 {
    ...
    public static void main(String args[]) throws IOException, IloException{
        ...
        CCQSPModelRelaxed2 model = new CCQSPModelRelaxed2(cplex, inst, "CCQSP");
        model.execute(10000, 0, 1);
        model.plot();
    }
    
    public CCQSPModelRelaxed2(CplexExtended cplex, CCQSPInstance inst, String name) throws IloException {
        this.cplex = cplex;
        this.inst = inst;
        this.name = name;
...
//            Xt[t][2].setUB(inst.map.maxY);
        ...
        Tk = cplex.numVarArray(inst.I(), 0, inst.map.T, "T");
        //Tk = cplex.intVarArray(inst.qsp.K, 0, inst.map.T, "T");
...
//                IloNumVar w = cplex.numVar(0, 1, "w");
//                cplex.addIF_Le_Them_Y("I.Le", z, exp);
//                cplex.addIF_Ge_Them_Y("I.Ge", w, exp);
