 ...
 * @author marcio
 */
public abstract class CplexIntFunction2v_ implements iCplexFunction2v{
    ...
    public CplexIntFunction2v_(CplexExtended cplex, int N, int M, String name) throws IloException {
        this.N = N;
        this.M = M;
        this.name = name;
