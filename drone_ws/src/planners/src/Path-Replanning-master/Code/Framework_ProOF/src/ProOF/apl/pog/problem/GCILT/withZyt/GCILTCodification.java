 ...
 * @author Hossomi
 */
public class GCILTCodification extends Codification<GCILTWProblem, GCILTCodification> {

    public LinkedList<GCILTLot>[][] Syt;
    public int Zy[];
    
    public GCILTCodification(GCILTWProblem gcilt) {
    ...
    @Override
    public void copy(GCILTWProblem gcilt, GCILTCodification source) throws Exception {
        for (int y = 0; y < gcilt.inst.Y; y++) {
            for (int t = 0; t < gcilt.inst.T; t++) {
    ...
    @Override
    public GCILTCodification build(GCILTWProblem gcilt) throws Exception {
        return new GCILTCodification(gcilt);
    }
    
    public void print( GCILTWProblem problem ) {
