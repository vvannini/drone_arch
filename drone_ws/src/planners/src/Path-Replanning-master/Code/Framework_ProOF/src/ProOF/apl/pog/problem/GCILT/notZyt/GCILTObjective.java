 ...
 * @author Hossomi
 */
public class GCILTObjective extends SingleObjective<GCILTNProblem, GCILTCodification, GCILTObjective> {
    ...
    @Override
    public void evaluate(GCILTNProblem problem, GCILTCodification codif) throws Exception {
    ...
    @Override
    public GCILTObjective build(GCILTNProblem mem) throws Exception {
